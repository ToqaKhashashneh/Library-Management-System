...
<img class="img-profile rounded-circle" src='<%= ResolveUrl("~/Rudaina/img/avatar.jpg") %>'>
     ...
     <div class="container mt-4">
         <h2 class="text-center text-primary mb-4" style="margin-top:80px !important; color:#a04fe2 !important;">Manage Reservations</h2>
             ...
             <asp:GridView ID="gvReservations" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-hover"
                 ...
                 <Columns>
                     ...
                     <asp:TemplateField HeaderText="Action">
                         <ItemTemplate>
                             <div class="d-grid gap-2 d-md-flex justify-content-md-center " style="gap:10px !important;"  >
